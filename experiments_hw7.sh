...
# echo "(Q3) Training Pupper Sim2Real - Vanilla"
# python run_hw7_sim2real.py meta.add_to_runname="Q2.1" sim2real.history_len=0 

echo "(Q3) Training Pupper Sim2Real - History Length : 0 ..."
python run_hw7_sim2real.py meta.add_to_runname="Q3h0" sim2real.history_len=0 
...
# echo "(Q3) Training Pupper Sim2Real - Vanilla"
# python run_hw7_sim2real.py meta.add_to_runname="Q2.1" sim2real.history_len=0 meta.sac_instead=True

# echo "(Q3) Training Pupper Sim2Real - History Length : 0 ..."
# python run_hw7_sim2real.py meta.add_to_runname="Q3h0" sim2real.history_len=0 meta.sac_instead=True
